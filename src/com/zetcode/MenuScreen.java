...
class MenuScreen extends JPanel  {
	...
	public MenuScreen() {
		...
		la=new JLabel(new ImageIcon(Resource.backgroundDir+"소코반로고.png"),JLabel.CENTER);
		exit=new JButton(new ImageIcon(Resource.buttonDir+"exit버튼2.png"));
		start=new JButton(new ImageIcon(Resource.buttonDir+"start버튼.png"));
